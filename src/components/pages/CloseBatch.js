            ...
            <Modal show={props.show} size={showPreview?'lg': ''}>
                                        ...
                                        <div className="col-md-8">
                                            <div className="input-group mb-3">
                                                ...
                                                <input
                                                    ...
                                                    {...register(`weightList[${index}].weight`, {
                                                        required: "Please enter number of birds",
                                                        pattern: {
                                                            value: /^\d+(\.\d{1,2})?$/, // This regex allows up to three decimal places
                ...
                <div>
                    ...
                    <Modal.Footer>
                        ...
                        <button type="button" className="btn btn-info"
                        onClick={() =>setShowPreview(false)}>Back</button>
                        <Button variant="secondary" onClick={handleChange}>Exit</Button>
                    </Modal.Footer>
                </div>
                } 
